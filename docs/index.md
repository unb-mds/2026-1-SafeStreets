...
<div style="display: flex; flex-wrap: wrap; gap: 32px; margin-top: 16px; justify-content: flex-start;">

  <div style="text-align: center; width: 130px;">
    <div style="width:120px; height:120px; border-radius:50%; border:3px solid #2e7d32; overflow:hidden; margin:0 auto;">
      <img src="imagens/foto-arthur.jpeg" style="width:100%; height:100%; object-fit:cover; object-position:center top; display:block;" alt="Arthur Feitosa"/>
    </div>
    <br/><strong>Arthur Feitosa</strong><br/>
    <a href="https://github.com/ArthurFeitosa05" target="_blank">@ArthurFeitosa05</a>
  </div>

  <div style="text-align: center; width: 130px;">
    <div style="width:120px; height:120px; border-radius:50%; border:3px solid #2e7d32; overflow:hidden; margin:0 auto;">
      <img src="imagens/foto-edson.jpeg" style="width:100%; height:100%; object-fit:cover; object-position:center top; display:block;" alt="Edson Gabriel"/>
    </div>
    <br/><strong>Edson Gabriel</strong><br/>
    <a href="https://github.com/EdsonToppzera" target="_blank">@EdsonToppzera</a>
  </div>

  <div style="text-align: center; width: 130px;">
    <div style="width:120px; height:120px; border-radius:50%; border:3px solid #2e7d32; overflow:hidden; margin:0 auto;">
      <img src="imagens/foto-israel.jpeg" style="width:100%; height:100%; object-fit:cover; object-position:center bottom; display:block;" alt="Israel Soares"/>
    </div>
    <br/><strong>Israel Soares</strong><br/>
    <a href="https://github.com/IsraelSoares-25" target="_blank">@IsraelSoares-25</a>
  </div>

  <div style="text-align: center; width: 130px;">
    <div style="width:120px; height:120px; border-radius:50%; border:3px solid #2e7d32; overflow:hidden; margin:0 auto;">
      <img src="imagens/foto-queiroz.jpeg" style="width:100%; height:100%; object-fit:cover; object-position:center top; display:block;" alt="Matheus Queiroz"/>
    </div>
    <br/><strong>Matheus Queiroz</strong><br/>
    <a href="https://github.com/matheusqsa" target="_blank">@matheusqsa</a>
  </div>

  <div style="text-align: center; width: 130px;">
    <div style="width:120px; height:120px; border-radius:50%; border:3px solid #2e7d32; overflow:hidden; margin:0 auto;">
      <img src="https://github.com/jorgevasquez25.png" style="width:100%; height:100%; object-fit:cover; object-position:center; display:block;" alt="Jorge Vasquez"/>
    </div>
    <br/><strong>Jorge Vasquez</strong><br/>
    <a href="https://github.com/jorgevasquez25" target="_blank">@jorgevasquez25</a>
  </div>

  <div style="text-align: center; width: 130px;">
    <div style="width:120px; height:120px; border-radius:50%; border:3px solid #2e7d32; overflow:hidden; margin:0 auto;">
      <img src="https://github.com/Nic0laslc.png" style="width:100%; height:100%; object-fit:cover; object-position:center; display:block;" alt="Nicolas Lopes"/>
    </div>
    <br/><strong>Nicolas Lopes</strong><br/>
